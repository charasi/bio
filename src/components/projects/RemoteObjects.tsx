...
import { remoteObjectDesc } from "../../descriptions/RemoteObjectDesc.ts";

export const RemoteObjects = () => {
  const { flipState, setFlipState } = useFlipStore();
  const [isReady, setIsReady] = useState(false);
  const refTagElement: string = "#remote-objects";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mr-8 flex-shrink-0">
        ...
        <img
          src="/pics/remoteobjects.png"
          id="remote-objects"
          alt="Remote Objects"
          data-flip-id="Remote-Objects"
    ...
    transition duration-300 ease-in-out hover:scale-110"
      ...
      <div className="flex flex-col space-y-3 w-full overflow-visible pr-2">
        {remoteObjectDesc.map((section, index) => (
          <div
            key={index}
